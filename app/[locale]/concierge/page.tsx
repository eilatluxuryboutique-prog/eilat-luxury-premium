        ...
        <div className="min-h-screen bg-white pt-24 pb-20">
            ...
            <div className="container mx-auto px-4 text-center mb-16">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-zinc-900 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-zinc-50 border border-zinc-100 rounded-3xl overflow-hidden hover:border-gold/50 transition-all duration-300 group hover:-translate-y-2 hover:shadow-[0_10px_40px_-10px_rgba(212,175,55,0.15)]"
                        >
            ...
            <div className="container mx-auto px-4 mt-20 max-w-4xl">
                <div className="bg-gradient-to-r from-gold/20 to-yellow-600/20 rounded-3xl p-8 md:p-12 text-center border border-gold/30 backdrop-blur-sm relative overflow-hidden">
                    ...
                    <h2 className="text-3xl font-bold text-zinc-900 mb-4 relative z-10">יש לכם בקשה מיוחדת?</h2>
                    <p className="text-zinc-700 mb-8 max-w-xl mx-auto relative z-10">
