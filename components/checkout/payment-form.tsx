    ...
    if (isSuccess) {
        return (
            <div className="bg-[#1E1E1E] border border-gold/30 rounded-2xl p-8 text-center animate-in fade-in zoom-in duration-500">
                ...
                <p className="text-neutral-400 mb-6">Your booking has been confirmed. You will receive an email shortly.</p>
    ...
    return (
        <div className="bg-[#1E1E1E] border border-white/10 rounded-2xl p-6 md:p-8">
            ...
            <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-sm text-neutral-500">Or pay with card</span>
                <div className="h-px bg-white/10 flex-1" />
            </div>
            ...
            <form onSubmit={handlePayment} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-[#121212] border border-white/10 rounded-lg p-3 text-white focus:border-gold outline-none transition-colors"
                    />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="text-xs text-neutral-400 block mb-1.5">Expiry Date</label>
                        <input
                            type="text"
                            required
                            placeholder="MM/YY"
                    ...
                    <div>
                        <label className="text-xs text-neutral-400 block mb-1.5">CVC</label>
                        <div className="relative">
                            <input
                                type="text"
                                required
